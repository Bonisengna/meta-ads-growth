...
import OperationalCampaignTable from "@/components/OperationalCampaignTable";
import { apiGet, apiGetStatus, apiPatch, apiPost, isSessionExpired, query } from "@/lib/api";
import { getSupabaseBrowserClient, isSupabaseConfigured } from "@/lib/supabase";
import type { BreakdownPoint, Campaign, Client, Dashboard, EntityPerformance, Improvement, ManagedClient, MetaAccount, MetaHealth, Metrics, Page, Recommendation, SettingsData, SyncRequest, SyncRun } from "@/lib/types";
